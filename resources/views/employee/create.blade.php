                ...
                <div class="p-5 bg-light rounded-3 border col-xl-6">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            {{-- untuk memunculkan perintah error pada kolom first name --}}
                            @error('firstName')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            {{-- untuk memunculkan perintah error pada kolom last name --}}
                            @error('lastName')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            {{-- untuk memunculkan perintah error pada kolom email --}}
                            @error('email')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            {{-- untuk memunculkan perintah error pada kolom age--}}
                            @error('age')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                        </div>
